TRANSLATIONS = {
    "ru": {
        ...
        "rename_func_title": "Переименовать функцию",
        ...
        "restart_required_message": "Изменения языка вступят в силу после перезапуска приложения.",
    },
    "en": {
        "app_title": "Vexapay Disassembler",
        ...
        "rename_func_title": "Rename Function",
